...
<body class="sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed control-sidebar-slide-open text-sm">
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-white">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                @if (Auth::user()->tipo == 'ADMINISTRADOR')
                    <li class="nav-item">
                        <a href="{{ route('users.control') }}" data-toggle="tooltip" title="Usuarios Monitoreo"
                            class="nav-link"><i class="fa fa-desktop"></i></a>
                    </li>
                @endif
        ...
        <aside class="main-sidebar elevation-4 sidebar-teal bg-teal">
            <!-- Brand Logo -->
            <a href="{{ route('home') }}" class="brand-link" style="color:black!important;">
                ...
                <span class="brand-text">{{ app\RazonSocial::first()->alias }}</span>
            </a>
        ...
        <input type="hidden" id="urlNotificaciones" value="{{ route('notificacions.user') }}">
        <input type="hidden" id="totalNotificaciones" value="{{ count(Auth::user()->notificacions_user) }}">
        @php
            $stock_bajo = 'NO';
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; {{ date('Y') }} SEOCAMRFID</strong>
