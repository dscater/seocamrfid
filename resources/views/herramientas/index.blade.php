                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('herramientas.create') }}" class="btn btn-info"><i class="fa fa-plus"></i>
                                Nuevo</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($herramientas as $herramienta)
                                        <tr>
                                            ...
                                            <td><img src="{{ $herramienta->url_foto }}" alt="Foto" class="img-table">
                                            </td>
                                            ...
                                            <td class="btns-opciones">
                                                ...
                                                <a href="#"
                                                    data-url="{{ route('herramientas.destroy', $herramienta->id) }}"
