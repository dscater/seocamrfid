...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Materiales en Obras</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <h3>Reportes - Materiales en Obras</h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
    ...
    <input type="hidden" value="{{ route('reportes.obrasMateriales') }}" id="urlInfoGrafico">
@endsection
