...
<div class="card contenedor_datos">
    <div class="card-body pb-1">
        <input type="hidden" name="materials[]" class="valores" value="0|1">
        <p class="mb-1 editable">
            <strong>Nombre: </strong><span>Material #1</span>
            <select name="" id="" class="input_form oculto">
            </select>
        </p>
        <p class="mb-0 editable">
            <strong>Cantidad: </strong> <span>1</span>
            <input type="number" data-index="1" value="1" class="input_form oculto">
        </p>
    </div>
...
<div class="card contenedor_datos">
    <div class="card-body pb-1">
        <input type="hidden" name="herramientas[]" class="valores" value="0|1|2023-07-10|2023-07-20">
        <p class="mb-0 editable">
            <strong>Nombre: </strong><span>Herramienta #1</span>
            <select name="" id="personal_id" class="input_form oculto">
            </select>
        </p>
        <p class="mb-0 editable">
        ...
        <p class="mb-0 editable">
            ...
            <input type="date" data-index="2" value="2023-07-10" class="input_form oculto">
        </p>
        <p class="mb-0 editable">
            <strong>Fecha Finalización: </strong> <span>2023-07-20</span>
            <input type="date" data-index="3" value="2023-07-20" class="input_form oculto">
        </p>
    </div>
    <div class="card-footer">
        <button type="button" class="btn btn-xs btn-danger eliminar"><i
...
let input_eliminado = `<input type="text" name="eliminados[]">`;
